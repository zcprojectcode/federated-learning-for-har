class FLConfig:
    def __init__(self, algorithm: str = "fedavg", num_clients: int = 30):
        ...
        self.num_rounds = 25           # Global aggregation rounds
        self.local_epochs = 2          # Local epochs per client
        self.frac = 0.5                # Fraction of clients each round
        ...
        self.f = 0.3                   # Scaling factor for accuracy and energy awareness
        ...
        self.accuracy_aware_agg = True # If True, include accuracy term in model aggregation (FedAvg)
